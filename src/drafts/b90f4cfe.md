---
title: "Claude did not outsmart mathematicians. It outlasted them."
date: 2026-08-13
excerpt: "Claude used 60 agents, 31 million tokens and 650 failed attempts to move a mathematical bound that had barely moved in decades. The breakthrough was not genius. It was failure without fatigue, and that changes what leadership is for."
tldr: "Anthropic reports that an unreleased research version of Claude tried 650 ideas that failed, then coordinated roughly 60 subagents across 31 million output tokens to prove a new lower bound on the zeros of the Riemann zeta function. The lesson for leaders is not that machines outthink us. It is that persistence has become a purchasable input, which means the human job shifts to choosing worthy questions, defining evidence, and writing stopping rules before a tireless system turns every hunch into an endless campaign."
layout: post.njk
tags:
  ...
  - agentic-ai
  - strategy
featuredImage: "/images/posts/claude-riemann-zeta-persistence.webp"
...
I think this is one of the most important AI stories of the year, and not because of the mathematics. It matters because of what the 650 failed attempts cost. For a machine, failure number 649 carries no fatigue, no embarrassment in front of colleagues, and no performance review. Those human costs did not disappear; they were converted into a line item. And once persistence becomes a line item, the leadership question changes completely.

<div class="chapter-tldr"><span class="chapter-tldr__label">In short</span><p>Anthropic says an unreleased research Claude tried 650 ideas that failed, then coordinated about 60 subagents across 31 million output tokens to produce a new, verified mathematical result. It did not prove the Riemann hypothesis. What it demonstrated is that persistence can now be purchased as a metered input, and that changes what leaders are for.</p></div>

## What actually moved

The mathematics deserves one careful paragraph, because the leadership lesson depends on getting it right. In 1859, the German mathematician Bernhard Riemann published a memoir connecting a function, now called the Riemann zeta function, to the distribution of prime numbers. The function's nontrivial zeros, the points where its value falls to zero for deep structural reasons, encode increasingly fine information about how primes are spaced. Riemann conjectured that every one of these zeros lies on what is now called the critical line, the set of inputs whose real component equals exactly one-half. That conjecture is the Riemann hypothesis, and it remains open.

What Claude's paper proved is a lower bound: a guaranteed minimum share of zeros on the critical line, not a claim that all of them are there. The [previous record was 5/12](https://www-cdn.anthropic.com/564f962e60643842f5fcb4a17c9dbc8f608f1c37.pdf), about 41.7 percent, and it had stood since 2020. The new theorem proves at least 2/3, about 66.7 percent, with an optimized constant of 0.6725. That is a jump of 25 percentage points. The "37-year record" framing you may have seen refers to the interval since J. B. Conrey's [1989 paper](https://doi.org/10.1515/crll.1989.399.1) proved that more than two fifths of zeros lie on the line; human mathematicians kept improving the bound after Conrey, so the field was never frozen for all 37 years.

I want to be precise here because the precision is the point. This was a genuine, bounded advance on a live research frontier, checked by human specialists, not a machine solving a famous problem in one leap.
...
The newsletter AI Secret summarized the story in one sentence: ["This wasn't genius. It was stamina."](https://aisecret.us/a-37-year-math-record/) I think that sentence is half right, and the half it misses matters. The proof did not come from raw repetition. It stands on decades of human mathematics, including a 2023 paper by Baluyot, Goldston, Suriajaya, and Turnage-Butterbaugh, [published in Acta Arithmetica in 2024](https://arxiv.org/abs/2306.04799), that supplied the prior machinery, and it added what the paper calls a new linear-algebraic reading of that machinery. Whether that reading counts as insight or search is genuinely unclear to me. I don't know, and Anthropic's disclosure cannot settle it, because nobody ran the counterfactual with fewer agents or a smaller budget.
...
Here is where I want to be careful with my own framing. When I say fatigue, shame, and career risk became a compute budget, that is a metaphor, not a measurement. Anthropic measured none of those things. But the metaphor points at something structural: the 650th attempt costs a machine nothing socially, while attempt number 650 has ended human careers. An organization can now provision a large, instrumented search the way it provisions cloud capacity. The bottleneck is no longer who can endure the dead ends. It is who decides which dead ends are worth funding.
...
2. **Specify the evidence contract.** State in advance what counts as success, disconfirmation, novelty, and sufficient independent verification, and require a checker with a different failure mode than the producer, whether that is a domain expert, an independent method, or a formal proof.
...
5. **Write the stopping rules before the agents start.** Stop when novelty yield falls below a threshold, when the same failure mode recurs without a new hypothesis, when independent review cannot reproduce the claim, or when the next batch is worth less than the next portfolio candidate.
...
I don't know whether Claude's zeta campaign will be remembered as a mathematical milestone or as an unusually well-instrumented anomaly; the field will decide that over the next few years. I am confident about the managerial reading. When any employee, human or artificial, can afford a thousand dead ends, the scarce resource is the person who decides which mountain of dead ends is worth buying, and who writes down, before the first attempt runs, what would make them stop. That decision is the job now.

<div class="chapter-tldr"><span class="chapter-tldr__label">In short</span><p>Execution became cheap, and now persistence is becoming cheap. What stays expensive is judgment: choosing worthy questions, defining the evidence that ends a search, and owning the consequences. Leadership is the stopping rule.</p></div>
