...
description: "Anthropic says Claude raised a lower bound for the Riemann zeta function, a mathematical tool for studying prime-number patterns: a zero is an input where the function equals zero, and the bound is a proven minimum share of such zeros lying on a specified line. The case turns AI persistence into a leadership question about evidence, budgets, and when to stop."
tldr: "Anthropic reports that an unreleased Claude system produced 31 million units of model-generated text and, after 650 failed ideas, coordinated about 60 delegated AI processes to raise a proven minimum share of Riemann zeta zeros, inputs where that mathematical function equals zero, on its critical line. The result did not prove the Riemann hypothesis, and Anthropic disclosed neither a full cost ledger nor a controlled test showing persistence caused it. The leadership lesson: humans must choose worthy questions, define independent evidence, and assign stopping authority before another batch begins."
...
The tempting explanation is that Claude simply outlasted mathematicians. I think that is too clean. Anthropic published no controlled comparison showing that the number of attempts caused the result, and its public account contains no complete cost ledger. The successful route also depended on decades of human mathematics, a new conceptual reading of prior work, numerical tests, software-assisted proof checking, and specialist review.
...
Claude's [preprint, a research paper released before conventional journal peer review](https://www-cdn.anthropic.com/564f962e60643842f5fcb4a17c9dbc8f608f1c37.pdf), proves something narrower. As mathematicians count zeros at increasingly great heights, the paper raises the proven minimum share on the critical line from 5/12, about 41.67 percent, to at least 2/3, about 66.67 percent, with an optimized result of 0.6725, or 67.25 percent. This is an asymptotic statement about the long-run proportion, not a census at one fixed height. The denominator in that proportion is the total zero count, which treats a repeated zero according to its multiplicity, meaning the number of times it occurs. A companion theorem, also checked in the released proof software, says at least the same stated proportion are simple, meaning they occur once, and lie on the critical line. The remaining zeros are not thereby shown to lie off the line; a lower bound proves a minimum, not the full hypothesis.

The popular 37-year framing also needs care. Number theorist J. B. Conrey proved that more than two fifths lie on the line in a [peer-reviewed 1989 paper](https://doi.org/10.1515/crll.1989.399.1), but later mathematicians continued to improve the result, reaching the previous 5/12 record in 2020. Claude's paper credits a peer-reviewed 2024 precursor by four number theorists and describes its own new ingredient as using linear algebra, the mathematics of vectors and matrices, to read that work differently. The achievement emerged from a living research chain, not a machine starting from an empty page.

Anthropic reports 2,400 command-line instructions, hundreds of small programs written in the Python language, numerical checks, searches for examples that would disprove candidate claims, proof review, and a search through 54 scholarly papers for prior work. Two Anthropic mathematicians studied the result, and two outside number theorists examined it on short notice. The company also released a [Lean 4 formalization](https://github.com/anthropics/zeta-23-lean). Lean 4 is a theorem-proving programming language; formal verification here means that software checked precisely encoded statements and proofs under declared logical assumptions. It adds an unusually strong rejection mechanism, although it is still separate from conventional journal review and wider scrutiny by the field.
...
<div class="chapter-tldr"><span class="chapter-tldr__label">In short</span><p>The result is a specific, asymptotic lower-bound advance built on decades of human mathematics. Its value could be tested through several independent checks, which makes it a favorable case for persistent AI search rather than a template that transfers automatically.</p></div>
...
Authority should be split because the people running a campaign are also the people most able to explain why its latest failure is promising. A business sponsor owns the question and its value. An evaluator outside the delivery team owns the acceptance test and tries to reproduce the result. An existing quarterly portfolio review owns renewal, because it can compare another batch with the best unfunded alternative.
