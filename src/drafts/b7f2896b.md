...
Benjamin Simkin makes a useful distinction in *The AI-First Company*. He talks about "retrofitters" — companies that bolt AI onto existing structures — versus "AI-first builders" that re-engineer from scratch. I think most large enterprises are retrofitters right now. They're stuck at the augmentation ceiling because they're adding agents to a structure designed for human-only coordination. The structure is the ceiling.
...
I think the opportunity here is enormous. Not just for efficiency, but for the kind of work people get to do. When the routine coordination work collapses, what's left is judgment, taste, and context. The work that actually matters. The leaders who embrace that will build teams that feel more alive, not less.
