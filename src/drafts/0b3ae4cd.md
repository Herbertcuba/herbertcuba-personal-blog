...
The case for redesign needs evidence from the work itself. Choose one contained workflow with measurable handoffs and an accountable domain owner. Record how long the work takes and how often it fails, define the decisions an agent may make, and create a route for human review. The performance data show whether routing can be automated reliably; the decision boundary and review route make the test safe. Together, they provide evidence for deciding whether a coordination layer can shrink. Invented ratios and fixed month-by-month promises offer false confidence.
