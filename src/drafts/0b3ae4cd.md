...
Simkin proposes a clean-slate exercise: *"If I were building this business today, from scratch, knowing what AI can do, would it look like this?"* Applied to one specific workflow, the question can expose an approval step kept by habit or a roadmap commitment, such as a rarely used feature that continues to create support exceptions. Removing that burden before rebuilding the workflow reduces the number of goals, handoffs, and exceptions the new system must reconcile, which lowers the practical cost of redesign.
