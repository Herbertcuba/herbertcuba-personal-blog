...
**The confirmation came yesterday.** ClickUp — once valued at $4 billion, one of the most celebrated productivity SaaS startups of the last decade — announced it had laid off **22% of its workforce**. CEO Zeb Evans framing it not as cost-cutting, but as "a radical embrace of AI" that would propel the company to what he called a "100x org." Workers, Evans said, were now expected to direct roughly 3,000 internal AI agents and review their output. Salary bands, he announced, would now top out in the millions — for those who could demonstrate "outsized impact using AI."

What Evans described is honest, actually. Strip away the optimism and this is the deal: the AI agents do the work. The remaining employees supervise the agents. Headcount drops. The question Evans left unanswered — the same question every mid-tier SaaS company is quietly asking itself — is what happens when the agents get good enough that you need fewer supervisors too.

The numbers are starting to tell the story nobody wants to narrate.

Gartner's most recent survey of companies deploying autonomous AI found that roughly 80% of them had cut jobs in the process. Here is the catch: those workforce reductions **are not translating into meaningful financial returns** — yet. Companies are laying people off on the promise that AI will close the gap. The gap is not closed.

That is the phase we are in right now. The squeeze, not the payoff.
