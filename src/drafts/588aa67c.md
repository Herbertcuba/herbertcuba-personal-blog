...
My take: none of this is surprising if you've been building persistent agentic workflows. When I published the [APEX Framework](https://cubagarcia.com/posts/2026-04-05-apex-framework/) in April, the judge/generator separation was already a core architectural requirement — not a novelty. The generator can't grade its own homework. Self-evaluation is a known failure mode. A structurally separate judge is how you fix it. Fusion just ran a clean benchmark on what APEX practitioners already treat as table stakes.
