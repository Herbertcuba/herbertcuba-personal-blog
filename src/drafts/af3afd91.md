...
Third, raw PDFs and screenshots. A 40 page spec dropped into the window as a PDF costs vastly more than the two paragraphs you actually need. Extract the text. Better, extract the section.
