...
date: '2026-09-23'
featuredImage: /images/drafts/b8cc024d2de43415.webp
draft: true
permalink: /drafts/b8cc024d2de43415/
...
<span class="scifi__label" id="scifi-b8cc024d2de43415-title">Meanwhile in sci-fi</span>
<p class="scifi__film">RoboCop (1987)</p>
<p>In <em>RoboCop</em>, ED-209 is heavily armed, obedient, and almost comically bad at context. Give it a clear instruction and it acts. Change the conditions slightly and the power becomes the problem.</p>
<p>That is a useful model for CMS agents. More available actions do not make an agent more capable. Without narrow permissions, human checkpoints, and a visible record of what happened, autonomy only increases the distance a bad decision can travel.</p>
</aside>
