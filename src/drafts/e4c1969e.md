...
**Velocity: 20x** — parallel execution across multiple agents. What changes at this level: **scale**. You go from one-to-one to one-to-many. But you also discover something uncomfortable — at this pace, your bottleneck shifts from *production* to *verification*. You can generate more output than you can meaningfully review.
...
**Velocity: 100x** — production runs continuously, not just when you are at the keyboard. What changes at this level: **who initiates**. For the first time, it is not you. The system has its own momentum.
