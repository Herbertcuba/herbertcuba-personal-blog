...
<div class="statband">
<p class="fig-cap">What the shift is worth, measured</p>
  <div class="statband__grid">
    <div class="statband__item"><div class="statband__num">+14%</div><div class="statband__label">avg productivity across 5,179 support agents — +34% for novices (Brynjolfsson, Li &amp; Raymond, 2023)</div></div>
    <div class="statband__item"><div class="statband__num">~37%</div><div class="statband__label">less time on professional writing tasks, quality up (Noy &amp; Zhang, <em>Science</em>, 2023)</div></div>
    <div class="statband__item"><div class="statband__num">+40%</div><div class="statband__label">higher quality output from consultants on fitting tasks (BCG × Harvard, 2023)</div></div>
  </div>
</div>

## The Tool Ceiling

<div class="chapter-tldr"><span class="chapter-tldr__label">In short</span><p>A tool multiplies one person's hands. It makes you faster at the work you already do — which means the best case is the human ceiling, reached sooner. A colleague multiplies your reach, and that's a different ceiling entirely.</p></div>
...
<div class="chapter-tldr"><span class="chapter-tldr__label">In short</span><p>Treating AI as a colleague isn't a poetic stretch — it's how human brains are already wired. Thirty years of research shows people apply social rules to computers automatically, without deciding to. The reframe just stops you fighting your own instincts.</p></div>
