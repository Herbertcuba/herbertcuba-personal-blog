...
- [Chapter 4: Three Areas and Nine Domains](#chapter-4-three-areas-and-nine-domains)
- [Chapter 5: Domain Ownership](#chapter-5-domain-ownership)
- [Chapter 6: APEX Metrics](#chapter-6-apex-metrics)
- [Chapter 7: The APEX Execution Loop](#chapter-7-the-apex-execution-loop)
...
Everything in APEX revolves around three phases that repeat continuously: Strategic, Execution, and Reflection. I think of them as the macro rhythm of any agentic operation. Each phase has a distinct purpose, a distinct actor in the lead, and a distinct failure mode when neglected.
...
I've seen teams skip Reflection because delivery pressure is high. They ship, move on, start the next sprint. The result is predictable: the same problems repeat. Iteration depth stays flat. First-pass acceptance doesn't improve. The agents aren't getting smarter because nobody is feeding execution data back into the system.
...
## Chapter 4: Three Areas and Nine Domains
...
**QA Strategic** is the measurement and verification layer. Measurement plans, calibration specs, human verification criteria, definition of quality gates. This domain answers: how do we know the output is good enough?
...
APEX needs its own equivalent of DORA metrics, a small set of named indicators that cover the full cycle. Without these, data-driven Reflections are impossible. You're just guessing. I've landed on five.
...
## Chapter 7: The APEX Execution Loop
