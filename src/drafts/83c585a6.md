...
After a work cycle completes, the system pauses to learn. This phase runs at roughly 2-3x velocity compared to traditional retrospectives — agents pre-compile their metrics and surface patterns automatically, so humans spend time deciding rather than gathering data.
