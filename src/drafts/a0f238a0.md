...
The structural pattern is worth naming. Anthropic's founders left OpenAI over safety concerns, then built a competing lab with a safety mandate embedded in its charter. Multiple major AI labs have now published internal capability evaluation frameworks, essentially telling governments: here is how we measure when our own systems become too dangerous, because we are not sure you will notice before we do. These are not the actions of an industry that thinks the risk is manageable without outside help.
