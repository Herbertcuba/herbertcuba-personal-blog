...
The statement was triggered, at least in part, by something that happened ten days earlier. On June 12, the Trump administration blocked foreign nationals from accessing Anthropic's Fable and Mythos models — no warning, no wind-down period, no transition plan. [I wrote about it then](https://cubagarcia.com/posts/the-kill-switch-is-real/): one government, one evening, and an entire intelligence layer was gone for every non-US company that depended on it.
