  ...
  <div class="container">
    <div class="book-page__grid">
      <div class="book-page__cover">
        <img src="/images/crucibles-cover.jpg" alt="The 3 Crucibles book cover" />
      </div>
      <div class="book-page__content">
        <span class="book-teaser__eyebrow">Book</span>
        <h1 class="book-page__title">The 3 Crucibles</h1>
        <p class="book-page__subtitle">A Prophecy of Collapse, Transformation, and the Fight for Abundance</p>
        <p class="book-page__author">By Herbert Cuba Garcia</p>
        <div class="book-teaser__ctas">
          <a href="https://www.amazon.com/dp/B0GTK53C9H" target="_blank" rel="noopener" class="book-teaser__btn book-teaser__btn--primary">Buy on Amazon</a>
          <button class="book-teaser__btn book-teaser__btn--secondary js-open-book-modal" data-book="The 3 Crucibles" data-download="/downloads/three-crucibles.pdf" type="button">Get Free Copy</button>
        </div>
      </div>
    </div>
    ...
    <div class="book-page__body">
      ...
      <blockquote class="book-page__quote">
      ...
      <div class="book-page__cta-block">
        <a href="https://www.amazon.com/dp/B0GTK53C9H" target="_blank" rel="noopener" class="book-teaser__btn book-teaser__btn--primary">Buy on Amazon</a>
        <button class="book-teaser__btn book-teaser__btn--secondary js-open-book-modal" data-book="The 3 Crucibles" data-download="/downloads/three-crucibles.pdf" type="button">Get Free Copy</button>
      </div>
    </div>
