...
I wrote recently about [the five levels of AI-augmented production](/posts/five-levels-ai-augmented-production/) — from no AI to fully autonomous workflows. The velocity multipliers go from 1x to 50x. But there is something the multipliers do not show: at every level, the constraint that matters most is not the agent's capability. It is yours.
