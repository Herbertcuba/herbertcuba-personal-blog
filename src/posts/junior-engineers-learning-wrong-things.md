...
I wrote recently that [IQ got automated, but wisdom didn't](/posts/iq-got-automated-wisdom-didnt/). The same logic applies here. We spent decades building engineering careers around the skills that are easiest to automate — closed-problem solving, pattern execution, speed. The thing that stayed scarce was always judgment, context, and wisdom. AI just made that visible.
